...
function Diretrizes () {
    ...
    <div>
        ...
        <h2>📝 Termos de uso - Desbrave</h2>
        <p>Bem-vindo ao Desbrave, uma plataforma digital focada em educação, cultura e desafios interativos. <br/>
         ...
         <h4>Uso da plataforma</h4>
         <p>O Desbrave é uma plataforma educacional que oferece cursos online, desafios gamificados e fóruns de discussão. <br/> 
         ...
         a legislação vigente e as diretrizes da comunidade. <br/>
          ...
          <p>Todo o conteúdo da plataforma, incluindo textos, vídeos, imagens, gráficos, logotipos e materiais de cursos, é protegido por leis de direitos autorais. </p>

          <h4>Conduta do Usuário</h4>
          <p>Esperamos que todos os usuários mantenham uma postura respeitosa e ética. Não é permitido:</p>
          <p>❌ Publicar conteúdos ofensivos, discriminatórios ou que incitem ao ódio; <br/>
          ...
          <p>O Desbrave se reserva o direito de suspender ou excluir contas que violem essas regras, sem aviso prévio.</p>

          <h4>Modificações na Plataforma e nos Termos</h4>
          <p>Estamos sempre aprimorando nossos serviços. Por isso, podemos atualizar estes Termos de Uso a qualquer momento. <br/>
        ...
        <h4>Contato</h4>
        <p>Se você tiver dúvidas ou precisar de suporte, entre em contato conosco pelo e-mail: suporte@desbrave.com.</p>

        <h2>🔐 Política de Privacidade – Desbrave</h2>
        <p>O Desbrave valoriza a sua privacidade e está comprometido em proteger seus dados pessoais. <br/>
        ...
        <p>Coletamos informações que você nos fornece diretamente ao se cadastrar na plataforma, como nome, e-mail e dados de contato. <br/>
         ...
         <p>● Personalize sua experiência de aprendizado; <br/>
        ...
        <p>● For necessário para o funcionamento da plataforma (como serviços de hospedagem); <br/>
        ● Houve exigência legal ou judicial; <br/>
        ● Você autoriza expressamente.</p>

        <h4>Segurança dos Dados</h4>
        <p>Adotamos medidas de segurança para proteger suas informações contra acessos não autorizados, perda, uso indevido ou divulgação indevida. <br/>
        Isso inclui segurança de dados, protocolos de segurança e monitoramento contínuo.</p>

        <h4>Cookies e Tecnologias de Rastreamento</h4>
        <p>Usamos cookies para melhorar sua experiência, personalizar conteúdos e entender como você interage com a plataforma.</p>

        <h4>Seus direitos</h4>
        <p>Você tem o direito de:</p>
        <p>● Acessar, corrigir ou atualizar suas informações pessoais; <br/>
        ● Solicitar a exclusão dos seus dados da plataforma; <br/>
        ● Retire a autorização para o uso de seus dados a qualquer momento. </p>

        <p>Para exercer esses direitos, entre em contato pelo e-mail: privacidade@desbrave.com</p>
        <h4>Alterações na Política de Privacidade</h4>
        <p>Esta política pode ser atualizada periodicamente para refletir mudanças na legislação ou em nossos serviços.</p>
