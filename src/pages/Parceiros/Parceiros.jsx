    ...
    return (
        <div>
            ...
            <div className="seja-parceiro">
                ...
                <p className="text-parceiros">Seja nosso parceiro e impulsione seu <br/>
                negócio com soluções inovadoras e personalizadas! </p>
                ...
                {showInfo && (
                    <div className="info-parceiro">
                        ...
                        <p className="info-saiba-mais">Torne-se nosso parceiro e amplie suas oportunidades! O processo é simples: <br/>
                        ...
                        Ao se juntar a nós, você poderá hospedar seus cursos em nossa plataforma, alcançando mais alunos e expandindo seu negócio!</p>
                    </div>
                )}
            </div>

                <div className="formas-parceiro">
            <img src={formasparceiro} alt="FORMASPARCEIRO" />
            </div>
